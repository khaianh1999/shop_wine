<template>
    <div id="menuPrice" class="bg-gray-800 w-full py-9">
        <h2 class="text-center text-3xl text-amber-400 font-semibold uppercase">Khám phá menu</h2>
            ...
            <a href="#" class="lg:w-1/2 flex items-center p-4 block wow slideInLeft" data-wow-duration="1s">
                ...
                <div class="content w-full pl-4">
                    <div class="name_product flex justify-between border-dashed  border-b-2 border-gray-400 pb-2 mb-2">
                        ...
                        <span class=" text-amber-400 font-bold text-xl">500,000đ</span>
                    </div>
                    <div class="description text-lg text-gray-400 text-left md:w-2/3 leading-5">Hỗn hợp hương trái cây thơm ngon bổ dưỡng, mang hương vị say mê từng giọt...</div>
                </div>
            </a>
